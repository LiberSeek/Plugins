...
basekit.addField({
  authorizations: [
    {
      ...
      required: true,
      instructionsUrl: "https://model-router-console.edu-aliyun.com/open-api",
      icon: {
        light: shortcutIcon,
        dark: shortcutIcon
      }
  ...
  formItems: [
        ...
        options: [
          {
            ...
            value: "qwen/happyhorse-1.0-i2v"
          },
          {
            label: "Happyhorse t2v",
            value: "qwen/happyhorse-1.0-t2v"
          },
          {
            label: "Seedance",
    ...
    },
    {
      ...
      props: {
        placeholder: "写入生成视频的完整提示词，可在输入框中引用多维表字段",
        mode: "textarea"
      },
      validator: {
        required: true
    ...
    },
    {
      ...
      defaultValue: { label: `${DEFAULT_DURATION} 秒`, value: String(DEFAULT_DURATION) },
      validator: {
        required: false
      }
    },
    {
      ...
      props: {
        placeholder:
          "可选，Happyhorse 默认 https://model-router.edu-aliyun.com/v1，Seedance 默认 https://agentrs.jd.com"
      }
    }
  ],
  resultType: {
